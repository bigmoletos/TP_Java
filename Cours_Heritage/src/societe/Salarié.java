...
public abstract class Salarié {
	...
	private final String numSecu;// pas de setter car unique et final oblige à l'initaliser dans le consctruteur
									// et ne bougera plus ensuite
	private String nom;
