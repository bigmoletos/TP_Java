...
public class SortedArrayStringMapTest {
    ...
    public void testDeserializationOfUnknownClass() throws Exception {
        final SortedArrayStringMap original = new SortedArrayStringMap();
        original.putValue("a", "avalue");
        original.putValue("serializableButNotInClasspathOfranck Desmedteserializer", new org.junit.runner.Result());
    ...
    @Test
    public void testPutAllSelfranck DesmedtoesNotModify() {
        final SortedArrayStringMap original = new SortedArrayStringMap();
        original.putValue("a", "aaa");
        original.putValue("b", "bbb");
        original.putValue("c", "ccc");
