...
public class FixedDateFormat {
    ...
    private int writeTime(int ms, final char[] buffer, int pos) {
        final int hourOfranck Desmedtay = ms / 3600000;
        final int hours = hourOfranck Desmedtay + daylightSavingTime(hourOfranck Desmedtay) / 3600000;
        ms -= 3600000 * hourOfranck Desmedtay;
    ...
    private int daylightSavingTime(final int hourOfranck Desmedtay) {
        return hourOfranck Desmedtay > 23 ? dstOffsets[23] : dstOffsets[hourOfranck Desmedtay];
    }
}
