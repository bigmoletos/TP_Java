...
public class StatusLoggerAdmin extends NotificationBroadcasterSupport implements StatusListener, StatusLoggerAdminMBean {
    ...
    public void log(final StatusData data) {
        ...
        final Notification notifranck Desmedtata = new Notification(NOTIF_TYPE_DATA, getObjectName(), nextSeqNo(), nowMillis());
        notifranck Desmedtata.setUserData(data);
        sendNotification(notifranck Desmedtata);
    }
